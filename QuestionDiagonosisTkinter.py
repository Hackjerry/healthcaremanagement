######## A Healthcare Domain  to simulate the predictions of a General Physician ########
...
training_dataset = pd.read_csv('desktop/Training.csv')
test_dataset = pd.read_csv('desktop/Testing.csv')
...
doc_dataset = pd.read_csv('desktop/doctors_dataset.csv', names = ['Name', 'Description'])
...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        master.title("HEALTHCARE MANAGER")
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="  WELCOME TO HEALTHCARE MANAGER  ", bg="LavenderBlush3", width="50", height="10", font=("bold italic","25"))
        self.lblMsg.pack()
        self.btnLogin=Button(self, text="Login", height="3", bg="royal blue" ,width="20",font=("bold italic","25"), command=self.lblLogin_Click)
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="Register", height="3",bg="royal blue", width="20",font=("bold italic","25"), command=self.btnRegister_Click)
...
class Login(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self,height="3", bg="royal blue" ,width="40",font=("bold italic","25") ,text="Please enter details below to login")
        self.lblMsg.pack()
        self.username=Label(self,height="3", bg="light blue" ,width="20",font=("bold italic","25"), text="Username * ")
        self.username.pack()
        self.username_verify = StringVar()
        self.username_login_entry = Entry(self, textvariable=self.username_verify)
        self.username_login_entry.pack()
        self.password=Label(self,height="3", bg="light blue" ,width="20",font=("bold italic","25"), text="Password * ")
        self.password.pack()
        self.password_verify = StringVar()
        self.password_login_entry = Entry(self, textvariable=self.password_verify, show='*')
        self.password_login_entry.pack()
        self.btnLogin=Button(self, text="Login", width=8, height=2, command=self.btnLogin_Click)
        self.btnLogin.pack()
...
class SignUp(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self,height="3", bg="royal blue" ,width="40",font=("bold italic","25"),text="Please enter details below")
        self.lblMsg.pack()
        self.username_lable = Label(self,height="3", bg="light blue" ,width="20",font=("bold italic","25"),text="Username * ")
        self.username_lable.pack()
        self.username = StringVar()
        self.username_entry = Entry(self, textvariable=self.username)
        self.username_entry.pack()

        self.password_lable = Label(self,height="3", bg="light blue" ,width="20",font=("bold italic","25"), text="Password * ")
        self.password_lable.pack()
        self.password = StringVar()
        self.password_entry = Entry(self, textvariable=self.password, show='*')
        self.password_entry.pack()
        self.btnRegister=Button(self, text="Register", width=8, height=2, command=self.register_user)
        self.btnRegister.pack()
...
#        print("Hello")
        ...
        self.lblSucess=Label(root, text="Registration Success", fg="green", font=("calibri", 21))
        self.lblSucess.pack()
        self.btnSucess=Button(root,bg="light blue" ,width="20",font=("bold italic","25"), text="Click Here to proceed", command=self.btnSucess_Click)
        self.btnSucess.pack()
